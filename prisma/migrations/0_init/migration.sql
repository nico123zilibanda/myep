...
CREATE TABLE `AdminLog` (
    ...
    INDEX `AdminLog_adminId_fkey`(`adminId`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `Opportunity` (
    ...
    INDEX `Opportunity_categoryId_fkey`(`categoryId`),
    INDEX `Opportunity_createdById_fkey`(`createdById`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `SavedOpportunity` (
    ...
    INDEX `SavedOpportunity_opportunityId_fkey`(`opportunityId`),
...
CREATE TABLE `Training` (
    ...
    INDEX `Training_createdById_fkey`(`createdById`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
